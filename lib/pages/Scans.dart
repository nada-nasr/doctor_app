...
class Scans extends StatefulWidget {
  ...
  @override
  State<Scans> createState() => _Scans();
}

class _Scans extends State<Scans> {
  final attributes = ListModel(
      patientname: 'Patients',
      doctorname: 'Doctor',
      assistantname: 'Added By',
      date: 'Date',
      cla: 'class',
      action: 'Action');
                            ...
                            Container(
                              child: Row(children: [
                                ...
                                IconButton(
                                    ...
                                    onPressed: () {
                                      setState(() {
                                        Scans.removeAt(Scans.indexOf(item));
                                      });
                                    })
                              ]),
                            ),
...
class ListModel {
  ...
  String patientname, doctorname, assistantname, date, cla, action;
}
